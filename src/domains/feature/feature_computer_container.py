...
class FeatureComputerContainer:
    def __init__(self, file_feature_computer: FileFeatureComputer, features_post_computer: FeaturesPostComputer = NoPostComputing()) -> None:
    ...
    def identifier(self) -> str:
        ...
        features_post_computer_str = self.features_post_computer.__class__.__name__ if not isinstance(
            self.features_post_computer, NoPostComputing) else None
