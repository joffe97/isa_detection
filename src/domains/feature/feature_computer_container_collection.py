...
class FeatureComputerContainerCollection:
    ...
    def identifiers(
        ...
        return [
            feature_computer_container.identifier(ignore_features_post_computers)
            for feature_computer_container in self.feature_computer_containers
        ]

    def identifier(
        self, seperator="_", ignore_features_post_computers: Optional[list[Type[FeaturesPostComputer]]] = None
    ) -> str:
        if ignore_features_post_computers is None:
            ignore_features_post_computers = []
